...
public class CreepMovingScript : MonoBehaviour
{
    [SerializeField]
    ...
    private void Start()
    {
        ...
        healthBar = gameObject.transform.Find("ControlHealthCreep").gameObject;
        mainCamera = Camera.main;
        controlHealth = transform.Find("ControlHealthCreep").transform.gameObject.GetComponent<HealthBar>();
    ...
    [SerializeField]
    private float radiusAreaMoving = 3;
    private Vector3? destinationForRandomMove = null;
    [SerializeField]
    private float standDuration = 1;
    ...
    private void CollisionWithBullet(GameObject bulletGameObject)
    {
        ...
        {
            shooterFromBullet = bulletGameObject.GetComponent<BulletController>().GetShooter();
            if (health > 0)
            {
