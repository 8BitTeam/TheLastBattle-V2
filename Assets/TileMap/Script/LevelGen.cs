...
public class LevelGen : MonoBehaviour
{
    ...
    private Vector3 lastUpRightPosition;
    ...
    private void Awake()
    {
        ...
        lastUpRightPosition = levelPart_Start.Find("UpRightPoint").position;
    ...
    private void Update()
    {
        ...
        if (Vector3.Distance(playerPosition, lastUpRightPosition) < 30f)
        {
            SpawnLevelPartUpRight();
        }
    }
    private void SpawnLevelPartUpRight()
    {
        Transform chosenLevelPart = levelPart;
        Transform lastLevelPartTransform = SpawnLevelPart(chosenLevelPart, lastUpRightPosition);
        lastUpRightPosition = lastLevelPartTransform.Find("UpRightPoint").position;
